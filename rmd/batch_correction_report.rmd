...
write.table(rDIAUtils::pivotLonger(dat.precursor, valuesFrom='totalAreaFragment',
                                   rowsName=c('modifiedSequence', 'precursorCharge'),
...
write.table(rDIAUtils::pivotLonger(dat.precursor, valuesFrom='normalizedArea',
                                   rowsName=c('modifiedSequence', 'precursorCharge'),
                                   columnsName='replicate'),
...
write.table(rDIAUtils::pivotLonger(dat.precursor, valuesFrom='normalizedArea.bc',
                                   rowsName=c('modifiedSequence', 'precursorCharge'),
                                   columnsName='replicate'),
